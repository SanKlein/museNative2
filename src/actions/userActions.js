...
export const createUser = user => (dispatch, getState) => {
  ...
  return fetch(ActionTypes.URL + '/api/user/create', {
    method: 'POST',
    ...
    .catch(error =>
      dispatch({ type: ActionTypes.CREATE_USER_FAIL, error: 'Failed to create new user' })
    );
};
...
export const loadUser = _id => (dispatch, getState) => {
  return fetch(ActionTypes.URL + '/api/user', {
    method: 'POST',
    headers: { Accept: 'application/json', 'Content-Type': 'application/json' },
...
export const loadUserAnswers = _id => (dispatch, getState) => {
  return fetch(ActionTypes.URL + '/api/user/answers', {
    method: 'POST',
    headers: { Accept: 'application/json', 'Content-Type': 'application/json' },
    body: JSON.stringify({ _id })
  })
...
export const loadCategories = () => (dispatch, getState) => {
  return fetch(ActionTypes.URL + '/api/categories', {
    method: 'POST',
    headers: { Accept: 'application/json', 'Content-Type': 'application/json' }
  })
    .then(handleErrors)
...
export const updateStreak = user => (dispatch, getState) => {
  ...
  return fetch(ActionTypes.URL + '/api/user/streak', {
    method: 'POST',
    headers: { Accept: 'application/json', 'Content-Type': 'application/json' },
    body: JSON.stringify({ user })
  })
...
export const resetStreak = user_id => (dispatch, getState) => {
  ...
  return fetch(ActionTypes.URL + '/api/user/reset', {
    method: 'POST',
    headers: { Accept: 'application/json', 'Content-Type': 'application/json' },
...
export const saveEditUser = user => dispatch => {
  ...
  return fetch(ActionTypes.URL + '/api/user/update', {
    method: 'POST',
    headers: { Accept: 'application/json', 'Content-Type': 'application/json' },
    body: JSON.stringify({ user })
  })
